...
param virtualMachineManagedDiskStorageAccountType string = 'Standard_LRS'
...
var networkInterfaceName = 'toytruckserver154'
...
var virtualMachineOSDiskName = 'toyTruckServerOSDisk'
...
resource virtualNetwork 'Microsoft.Network/virtualNetworks@2022-05-01' = {
  ...
  // existing resource for network interface
    ...
    ipConfigurations: [
      {
        ...
        properties: {
          ...
          subnet: {
            id: virtualNetwork::defaultSubnet.id  // reference to the subnet in virtual network
          }
          primary: true
